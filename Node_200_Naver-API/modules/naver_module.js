...
import { NAVER_RES, SYSTEM_RES } from "../config/api_res_code.js";
...
export const getBooks = async (search) => {
  ...
  try {
     ...
     * 오류처리를 다른곳으로 일임 하기
     */
    const response = { ...NAVER_RES.FETCH_ERROR, MESSAGE: err.message };
  ...
  try {
    ...
    throw new Error(JSON.stringify(SYSTEM_RES.JSON_ERROR));
  }
